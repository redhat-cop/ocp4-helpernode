...
__EL 7__
```
wget https://raw.githubusercontent.com/redhat-cop/ocp4-helpernode/master/docs/examples/helper-ks-ppc64le.cfg -O helper-ks.cfg
```

__EL 8__
```
wget https://raw.githubusercontent.com/redhat-cop/ocp4-helpernode/master/docs/examples/helper-ks8-ppc64le.cfg -O helper-ks.cfg
```
